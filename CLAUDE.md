# Working agreements for AI assistants (Claude)

This file gives AI coding assistants the core rules for working in the Endora
repository. `AGENTS.md` carries the same agreements for other assistants. Keep
both in sync. For the full picture, read [README.md](README.md),
