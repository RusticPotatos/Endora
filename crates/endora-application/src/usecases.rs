...
fn personal_values_in(context: &ButlerContext) -> crate::pseudonyms::Pseudonyms {
    ...
    for line in &context.present {
        // "rustic is not home" — the name is what precedes the verb.
        ...
        // "on the Family calendar: E. Werner & M. Battaglia at 2026-07-31 18:30:00"
...
mod when_the_local_model_will_not_do_it {
    ...
    fn nothing_personal_reaches_the_deep_model_and_the_answer_comes_back_right() {
        ...
        let context = ButlerContext {
            present: vec![
                "rustic is not home; on the Family calendar: E. Werner & M. Battaglia at \
                 2026-07-31 18:30:00"
                    .to_owned(),
            ],
            ..ButlerContext::default()
        ...
        for personal in ["rustic", "E. Werner", "Battaglia"] {
            assert!(
        ...
        assert!(
            reply.text.contains("E. Werner & M. Battaglia"),
            "{}",
            reply.text
        );
...
mod its_own_behaviour_is_not_evidence_about_you {
    ...
    fn evidence_about_the_person_survives_endora_appearing_in_it() {
        ...
        for real in [
            "You asked 'Where did you find this?' after I listed some upcoming events in Charlotte.",
...
mod who_words_the_brief {
    ...
    const REAL_FACTS: &str = "- rustic is not home; on the Family calendar:                               E. Werner & M. Battaglia at 2026-07-31 18:30:00";
...
mod telling_the_person_from_the_household {
    ...
    fn the_persons_own_devices_are_marked_apart_from_the_house() {
        let record = TheRecord::of(super::readings_as_records(
            vec![
                ("person.rustic".to_owned(), "home".to_owned()),
        ...
        assert_eq!(kind("person.rustic"), Some(Source::Personal));
    ...
    fn with_nothing_known_to_be_theirs_everything_is_the_house() {
        ...
        let record = TheRecord::of(super::readings_as_records(
            vec![("person.rustic".to_owned(), "home".to_owned())],
            &[],
        ));
        assert_eq!(
