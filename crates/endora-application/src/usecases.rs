...
mod who_words_the_brief {
    ...
    fn a_brief_is_not_printed_twice() {
        ...
        let facts = "- morgan is not home; on the Family calendar: Yardwork at 2026-08-01\n- outside it is 80F and partlycloudy";
        let echoed = "Good morning. morgan is not home; on the Family calendar: Yardwork \
        ...
        let partial = "Good morning. morgan is not home.";
