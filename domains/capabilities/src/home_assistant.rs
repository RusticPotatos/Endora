...
mod which_things_are_the_persons_own {
    ...
    fn a_persons_own_trackers_are_theirs_and_so_is_the_person_entity() {
        let states = body(
            r#"{"entity_id":"person.rustic","attributes":{"device_trackers":["device_tracker.bambam","device_tracker.watch"]}},
    ...
    fn more_than_one_person_means_endora_will_not_guess() {
        ...
        let states = body(
            r#"{"entity_id":"person.rustic","attributes":{"device_trackers":["device_tracker.bambam"]}},
    ...
    fn a_person_with_no_trackers_still_counts_as_themselves() {
        let states = body(r#"{"entity_id":"person.rustic","attributes":{}}"#);
        assert_eq!(the_persons_own_things(&states), vec!["person.rustic"]);
    }
