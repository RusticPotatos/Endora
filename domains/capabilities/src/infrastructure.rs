    ...
    fn info(&self) -> CapabilityInfo {
        CapabilityInfo {
            ...
            settings: &[SettingSpec {
                key: "legistar_client",
                label: "your city's Legistar name (e.g. charlottenc)",
                secret: false,
                optional: false,
            }],
        }
...
/// and its event — *"E. Werner & M. Battaglia at 18:30"* — lives entirely in its attributes,
...
mod tests {
    ...
    fn nothing_claims_to_search_the_web_any_more() {
        ...
        // "charlotte nc events this week" and "what is on at bank of america stadium" both
...
mod what_a_thing_is_actually_telling_you {
    ...
    fn a_calendars_meaning_is_entirely_in_its_attributes() {
        ...
        assert_eq!(facts["message"], "E. Werner & M. Battaglia");
...
mod what_the_city_is_doing {
    ...
    const REAL: &str = r#"[
      {"EventId":1,"EventDate":"2026-08-03T00:00:00","EventTime":"9:00 AM",
       ...
       "EventLocation":"Charlotte-Mecklenburg Government Center, Room 267"},
