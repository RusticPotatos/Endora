...
//!
//! Identifiers are opaque values **supplied by outer layers** — the pure domain
//! never generates them, and it never reads the system clock. Time enters only
//! as a [`Timestamp`] passed in by the caller. This keeps the domain pure and
